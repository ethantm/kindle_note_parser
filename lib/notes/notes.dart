                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile.selectable(
                          ...
                          onPressed: () {
                            context.read<NotesBloc>().add(NotesBookSelected(
                                bookTitle: book[0].bookTitle, notes: book));
                          },
                        );
                      });
                }),
                                ...
                                title: Container(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "Note ${state.selectedNotes.indexOf(note) + 1} of ${state.selectedNotes.length}",
                                          style: Theme.of(context)
                                              .textTheme
                                              .labelMedium,
